...
const HomeStudentSection = () => {
  return (
    <main className='text-lightColor font-raleway font-regular uppercase flex flex-row lg:p-16 p-5'>
      <div className='flex flex-col w-1/3 items-end justify-center gap-20 sm:hidden'>
      ...
      <div className='flex justify-center items-center flex-col sm:w-full w-1/3'>
        <p className='-rotate-[15deg] pt-5 pr-16 sm:hidden'>
          otkrij u čemu si dobar!
        </p>
        <img src={students} alt='students' />
      </div>

      <div className='flex flex-col w-1/3 items-start justify-center gap-20 sm:hidden'>
